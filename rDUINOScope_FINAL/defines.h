...
double i[10] = {0.0, 7.00497902, 3.39467605, -0.00001531, 1.84969142, 1.30439695, 2.48599187, 0.77263783, 1.77004347, 17.14175}; // i Inclination
double o[10] = {0.0, 48.33076593, 76.67984255, 0.0, 49.55953891, 100.47390909, 113.66242448, 74.01692503, 131.78422574, 110.30347}; // o Longitude of the Ascending Node
double pl[10] = {0.0, 77.45779628, 131.60246718, 102.93768193, -23.94362959, 14.72847983, 92.59887831, 170.95427630, 44.96476227, 224.06676}; // pl Longitude of Perihelion
double a[10] = {0.0, 0.38709927, 0.72333566, 1.00000261, 1.52371034, 5.20288700, 9.53667594, 19.18916464, 30.06992276, 39.48168677}; // a Mean distance : distance from the Sun in UA
double n[10] = {0.0, 4.09233676, 1.6021293367, 0.985611, 0.523998, 0.083099, 0.033460358, 0.011731352, 0.006002, 0.003974}; // n Daily motion : number of degrees traveled in the orbit during an Earth day
double e[10] = {0.0, 0.20563593, 0.00677672, 0.01671123, 0.09339410, 0.04838624, 0.05386179, 0.04725744, 0.00859048, 0.24880766}; // e Eccentricity
double L[10] = {0.0, 252.25032350, 181.97909950, 100.46457166, -4.55343205, 34.39644051, 49.95424423, 313.23810451, -55.12002969, 238.92881}; // L Mean Longitude (orbital position for each planet on the date of the recorded elements)
double M[10], v[10], r[10], x[10], y[10], z[10], X[10], Y[10], Z[10], Xq[10], Yq[10], Zq[10], ra[10], dec_x[10];

//double i[10] = {0.0, 7.0052, 3.3949, 0.0, 1.8496, 1.3033, 2.4869, 0.7728, 1.7692, 17.1695}; //original informations
...
{
  {0, 0,  1, 0, 6288774, -20905355}, // moon data, checked by JG
...
{
  {0, 0,  0,  1, 5128122}, // Moon data, checked JG
  {0, 0,  1,  1,  280602},
  {0, 0,  1, -1,  277693},
  {2, 0,  0, -1,  173237},
  {2, 0, -1,  1,   55413},
